<template>
  <div class="details-box2">
    ...
    <!--单人贷款 -->
    <el-dialog :title="title" :visible.sync="showIndividual" width="580px" :before-close="closeIndividual">
      <el-form v-model="FinaceUserDetails" ref="ruleForm" label-width="100px" class="demo-ruleForm">
        ...
        <el-form-item label="上传材料：" prop="photo">
          <el-upload class="upload-demo" drag :action="upurl" multiple :headers="upheaders" :on-change="handleChange"
            :on-success="handleSuccess" :file-list="fileList" ref="upload">
    ...
    <!-- 组合贷款 -->
    <el-dialog :title="title" :visible.sync="showCombination" width="580px" :before-close="closeCombination">
...
export default {
  data() {
    return {
      ...
      fileList: [],
      imgurl: "",
      upurl: this.$store.state.fileUploadRoad + "/file/upload/info",
      data: [],
      Already: false,
      AuthorizationUser: {
        userName: "",
    ...
    individual() {
      ...
      selectFinaceUser({
        ...
        if (res.flag == true) {
          ...
          console.log("bank_id值为" + window.localStorage.financeObj.substring(10, 14));
          console.log("individual方法出错");
          console.log(this.$route.query.bankId);

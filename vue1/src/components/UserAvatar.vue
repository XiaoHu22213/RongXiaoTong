<template>
  <div class="user-avatar">
    ...
    <el-form label-width="100px">
      <el-upload class="user-avatar_el_upload" :action="upurl" :headers="upheaders" :limit="1" list-type="picture-card"
        :on-change="handleChange" :on-preview="handlePreview" :on-remove="handleRemove" :on-success="handleSuccess"
        :on-error="handleError" :file-list="fileList" :class="{ disUoloadSty: noneBtnImg }" ref="upload">

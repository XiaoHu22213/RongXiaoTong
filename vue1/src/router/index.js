...
import BankUserRegister from "../views/BankUserRegister";
import FinancingDetails from "../views/FinancingDetails";
import userGood from "../views/goodsManager.vue";
import AboutUs from "../views/AboutUs";
import index from "@/modules/index";
import intelligentMatch from "@/modules/intelligentMatch";
import financingList from "@/modules/financingList";
import financeDetail from "@/modules/financeDetail";
...
const routes = [
  ...
  {
    path: "/bankUserRegister",
    component: BankUserRegister,
  },
  {
    path: "/index",
    name: "index",
